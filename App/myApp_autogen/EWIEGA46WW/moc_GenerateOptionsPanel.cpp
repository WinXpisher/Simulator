...
static constexpr auto qt_meta_stringdata_ZN20GenerateOptionsPanelE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN20GenerateOptionsPanelE[] = {
...
Q_CONSTINIT const QMetaObject GenerateOptionsPanel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN20GenerateOptionsPanelE.offsetsAndSizes,
    qt_meta_data_ZN20GenerateOptionsPanelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN20GenerateOptionsPanelE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<GenerateOptionsPanel, std::true_type>
    >,
    nullptr
} };
...
void *GenerateOptionsPanel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN20GenerateOptionsPanelE.stringdata0))
