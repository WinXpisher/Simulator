    ...
    Resource*& outRes) const
{
    ...
    // Якщо завдання не завершено, переміщаємо його в кінець черги (якщо не 
    // завершено на цьому етапі). У реальному використанні повинні перевірити,
    // чи завдання завершено, чи воно має продовжуватися після свого відрізку часу
